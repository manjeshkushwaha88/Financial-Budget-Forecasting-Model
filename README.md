...
![Input Assumptions](images/input-assumptions.png)

### Financial Forecast Table

![Financial Forecast Table](images/financial-forecast-table.png)

### Income Statement Summary

![Income Statement Summary](images/income-statement-summary.png)
